...
public class frmBusquedaPerfil extends javax.swing.JFrame {
    ...
    public frmBusquedaPerfil() {
        ...
        objperfil.MostrarPerfilTodo(jtbPerfil);
        CargarCombo();
        PonerIcono();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Busqueda Perfil");
    ...
    private void txtValKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtValKeyPressed
        ...
        switch(criterio){
            ...
            if(txtVal.getText().equals("")){
                ...
                objperfil.BuscarPerfil(jtbPerfil, "codper" ,val);
            }
            ...
            if(txtVal.getText().equals("")){
                ...
                objperfil.BuscarPerfil(jtbPerfil, "nomper" ,val);
            }
            break;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmBusquedaPerfil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmBusquedaPerfil().setVisible(true);
            }
        });
    }
