...
public class frmBuscarEmpleado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 380, -1));

        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 10, 580, 60));

        jPanel4.setBackground(new java.awt.Color(204, 51, 0));
        jPanel4.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel4.add(cboFiltro, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 20, 180, 30));
        ...
        jPanel4.add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 20, 200, 30));
        ...
        jPanel4.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 30, 100, -1));

        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, 790, 80));
        ...
        jtbEmpleado.setToolTipText("");
        jScrollPane1.setViewportView(jtbEmpleado);

        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 850, 200));
        ...
        jPanel2.add(btnRegresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 390, -1, -1));
        ...
        switch (criterio) {
            ...
            case 1:
                if (txtVal.getText().equals("")) {
                    ...
                    objempleado.BuscarEmpleado(jtbEmpleado, "codemp", val);
                }
            ...
            case 2:
                if (txtVal.getText().equals("")) {
                    ...
                    objempleado.BuscarEmpleado(jtbEmpleado, "nomemp", val);
                }
                break;
            case 3:
                if (txtVal.getText().equals("")) {
                    ...
                    objempleado.BuscarEmpleado(jtbEmpleado, "nomdis", val);
                }
                break;
            case 4:
                if (txtVal.getText().equals("")) {
                    ...
                    objempleado.BuscarEmpleado(jtbEmpleado, "nomusu", val);
                }
                break;
            default:
                if (txtVal.getText().equals("")) {
    ...
    void CargarCombo() {
        cboFiltro.addItem("Seleccione un filto");
        cboFiltro.addItem("Codigo");
        cboFiltro.addItem("Empleado");
